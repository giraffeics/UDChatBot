                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            edge->SetParentNode((*childNode).get());
                            ...
                            std::unique_ptr<GraphEdge> edgeUniquePtr(edge);
                            (*parentNode)->AddEdgeToChildNode(std::move(edgeUniquePtr));
                        }
